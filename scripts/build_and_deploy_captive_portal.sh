...
# Define paths relative to the tollgate-module-basic-go directory
CAPTIVE_PORTAL_REPO_PATH="tollgate-captive-portal-site"
DESTINATION_PATH="files/tollgate-captive-portal-site"
...
# Navigate back to the original directory to use relative paths for rm and cp
echo "Navigating back to original directory..."
cd -
