...
replace github.com/OpenTollGate/tollgate-module-basic-go/src/tollwallet => ../tollwallet

replace github.com/OpenTollGate/tollgate-module-basic-go/src/utils => ../utils

replace github.com/OpenTollGate/tollgate-module-basic-go/src/valve => ../valve
