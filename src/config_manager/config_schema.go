			...
			Children: []FieldSchema{
				...
				},
				{
					...
					Children: []FieldSchema{
						...
						{Name: "BytesRenewalOffset", JSONKey: "bytes_renewal_offset", Type: "uint64", Description: "Renew this many bytes before limit", Default: uint64(32775000), Required: true, Editable: true},
					},
				},
				{
