...
- Download and install new packages if they are newer than the currently installed version
...
3. Download new package if event is valid and newer
4. Install new package using opkg
