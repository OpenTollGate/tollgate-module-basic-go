...
started_at: "2026-07-20T08:47:19.106Z"
session_id: "ses_0814ab1e4ffeNq3BM4Axeor9lr"
ultrawork: true
strategy: "continue"
...
we are having a lot of trouble with the go cashu wallet because it is unmaintained. recently https://github.com/cashubtc/cdk-go was released. evaluate if it might make sense for tollgate-module-basic-go to use this as a replacement for gonuts and make a feature branch to test it out. ultrawork. also consider making an issue to track the research and your findings. before starting, look at open issues and prs and summerize the trouble we have been having with gonuts and that it was never intended to rely on this in the long run
