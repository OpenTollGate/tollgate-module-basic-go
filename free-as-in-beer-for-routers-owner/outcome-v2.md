...
root@OpenWrt:/tmp# ./revert_private_ssid.sh 
Reverting private SSID configuration...
udhcpc: started, v1.36.1
udhcpc: broadcasting discover
udhcpc: no lease, failing
You cannot use UCI in firewall includes!
Include '/etc/config/firewall-tollgate' failed with exit code 1
Revert complete. The private SSID should now be removed.
root@OpenWrt:/tmp# ./setup_private_ssid_v2.sh 
Setting up private SSID...
udhcpc: started, v1.36.1
udhcpc: broadcasting discover
...
Connected to password protected gateway and got free internet while the non passowrd protected one still catches traffic with the captive portal.